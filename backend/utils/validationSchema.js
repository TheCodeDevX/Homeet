import { body, check } from "express-validator";
 ...
 export const ListingValidationSchema = [
    ...
    check("location").trim().notEmpty().withMessage("LOC_REQUIRED"),
     check("rentalType").trim().notEmpty().isIn(["nightly", "monthly", "for sale"]).withMessage("ENTER_RENTALPRICE"),
    ...
    check("amenities.*").trim().optional().isIn(["Wi-Fi","Furnished","Parking","Air Conditioning",
 ...
 export const ProfileSchema = [
    ...
    check("role").trim().notEmpty().isIn(["tenant", "homeowner", "seller"]),

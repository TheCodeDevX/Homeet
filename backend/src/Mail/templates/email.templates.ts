...
export const VERIFICATION_EMAIL_TEMPLATE = (userName:string, verificationCode:number) => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
export const WELCOME_EMAIL_TEMPLATE = (userName:string, token:string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
export const RESET_PASSWORD_TEMPLATE = (userName:string) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
padding: 20px;">
 ...
 export const PASSWORD_RESET_SUCCESS_TEMPLATE = (userName:string) =>  `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">

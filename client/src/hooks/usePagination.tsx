import { useListingStore } from "../store/listingStore";
 ...
 const usePagination = () => {
         //  Pagination 
   const {currentPage, setCurrentPage, listingsLength} = useListingStore()      
  const limit = 12;
 ...
 const pagination = () => {
  ...
  const startPage = Math.max(1, currentPage - 2 ) // -1. 0, 1 pages [1,2,3] will always show 1 as the start page
